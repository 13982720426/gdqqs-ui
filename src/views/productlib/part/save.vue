        ...
        <el-row v-if="type === 'install'">
            <el-col :span="8">
                <el-form-item label="部件类型" prop="partType">
                    <el-select v-model="form.partType" placeholder="请选择" clearable style="width: 60%"
                        @change="handlePartType">
                        <el-option v-for="dict in q_install_parttype" :key="dict.value" :label="dict.label"
                            :value="dict.value" />
                    </el-select>
                </el-form-item>
            </el-col>
            <template v-if="form.partType == 1">
                <el-col :span="8">
                    <el-form-item label="固定方式" prop="fixedMode">
                        <el-select v-model="form.fixedMode" placeholder="请选择" clearable style="width: 60%">
                            <el-option v-for="dict in q_fixed_mode" :key="dict.value" :label="dict.label"
                                :value="dict.value" />
                        </el-select>
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="轨道型号" prop="trackModel">
                        <el-select v-model="form.trackModel" placeholder="请选择" clearable style="width: 60%">
                            <el-option v-for="dict in q_track_model" :key="dict.value" :label="dict.label"
                                :value="dict.value" />
                        </el-select>
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="单根轨道长度(米)" prop="fixedMode">
                        <el-input v-model="form.sgltrackLength" placeholder="请输入单根轨道长度（米）" style="width: 60%" />
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="单根轨道重量(公斤/米)" prop="sgltrackWeight">
                        <el-input v-model="form.sgltrackWeight" placeholder="请输入单根轨道重量（公斤/米）" style="width: 60%" />
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                ...
                <el-col :span="8">
                    <el-form-item label="轨道压板单价" prop="tppUnprice">
                        <el-input v-model="form.tppUnprice" placeholder="请输入轨道压板单价" style="width: 60%" />
                    </el-form-item>
                </el-col>
                <el-col :span="8">
            ...
            <template v-else-if="form.partType == 2">
                ...
                <el-col :span="8">
                    <el-form-item label="滑触线单价" prop="trolleyUnprice">
                        <el-input v-model="form.trolleyUnprice" placeholder="请输入滑触线单价" style="width: 60%" />
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                ...
                <el-col :span="8">
                    <el-form-item label="安装费单价" prop="installUnprice">
                        <el-input v-model="form.installUnprice" placeholder="请输入安装费单价" style="width: 60%" />
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="指示灯单价" prop="idlightUnprice">
                        <el-input v-model="form.idlightUnprice" placeholder="请输入指示灯单价" style="width: 60%" />
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="上升电缆单价" prop="rcableUnprice">
                        <el-input v-model="form.rcableUnprice" placeholder="请输入上升电缆单价" style="width: 60%" />
                    </el-form-item>
                </el-col>
            </template>
            ...
            <template v-else-if="form.partType == 5">
        ...
        <el-row v-else>
            <el-col :span="8">
                <el-form-item label="部件类型" prop="partType">
                    <el-select v-model="form.partType" placeholder="请选择" clearable style="width: 60%"
                        @change="handlePartType">
                        <el-option v-for="dict in q_part_type" :key="dict.value" :label="dict.label"
                            :value="dict.value" />
                    </el-select>
                </el-form-item>
            </el-col>
            <el-col :span="8">
                <el-form-item label="起重机类型" prop="craneOperation">
                    <el-select v-model="form.craneType" placeholder="请选择" clearable style="width: 60%"
            ...
            <el-col :span="8">
                <el-form-item label="操作方式" prop="craneOperation">
                    <el-select v-model="form.craneOperation" placeholder="请选择" clearable style="width: 60%">
                ...
                <el-form-item label="起升高度" prop="liftHeight">
                    <template v-if="form.craneType == 1">
                        <el-select v-model="form.liftHeight" placeholder="请选择" clearable style="width: 60%">
                            <el-option v-for="dict in q_single_crane_lift_height" :key="dict.value" :label="dict.label"
                                :value="dict.value" />
                        </el-select>
                    </template>
                    <template v-else-if="form.craneType == 2">
                        <el-select v-model="form.liftHeight" placeholder="请选择" clearable style="width: 60%">
                            <el-option v-for="dict in q_double_crane_lift_height" :key="dict.value" :label="dict.label"
                                :value="dict.value" />
                        </el-select>
                    </template>
                    <template v-else-if="form.craneType == 3">
                        <el-select v-model="form.liftHeight" placeholder="请选择" clearable style="width: 60%">
                            <el-option v-for="dict in q_susp_crane_lift_height" :key="dict.value" :label="dict.label"
                                :value="dict.value" />
                        </el-select>
                    </template>
                </el-form-item>
                ...
                <el-form-item label="工作级别" prop="workLevel">
                    <template v-if="form.craneType == 1">
                        <el-select v-model="form.workLevel" placeholder="请选择" clearable style="width: 60%">
                            <el-option v-for="dict in q_single_crane_work_level" :key="dict.value" :label="dict.label"
                                :value="dict.value" />
                        </el-select>
                    </template>
                    <template v-else-if="form.craneType == 2">
                        <el-select v-model="form.workLevel" placeholder="请选择" clearable style="width: 60%">
                            <el-option v-for="dict in q_double_crane_work_level" :key="dict.value" :label="dict.label"
                                :value="dict.value" />
                        </el-select>
                    </template>
                    <template v-else-if="form.craneType == 3">
            ...
            <el-col :span="8">
                <el-form-item label="单位" prop="unit">
                    <el-select v-model="form.unit" placeholder="请选择" clearable style="width: 60%">
                        <el-option v-for="dict in q_unit" :key="dict.value" :label="dict.label" :value="dict.value" />
                    </el-select>
                </el-form-item>
            </el-col>
            <el-col :span="8">
